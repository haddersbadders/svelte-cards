...
export const load: PageLoad = async ({ fetch }) => {
    ...
    const sheetUrl = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vR032ubZhNyO0rChS20l_SiUFZ5kv8P-0yVTw1pnqtYdUemtjFjQIBvNWsL0ZhQ7ioPdCOjWUqW-yXc/pub?output=csv';
